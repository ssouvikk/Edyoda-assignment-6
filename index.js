...
function createCards(card_image,card_title,card_alt, card_text){
    ...
    cardHeader.innerHTML=card_title;
    var cardText=document.createElement('p');
    cardText.classList.add('cardText');
    cardText.innerHTML=card_text;
...
for(var i=0;i<cards.length;i++){
    var gridItem=createCards(cards[i].imgUrl,cards[i].header, cards[i].imgAlt, cards[i].description);
